...
export default function App() {
  const handleSubmit = (e) => {
    ...
    const phone = "971553729227";

    // Use API link to support browser and app
  ...
  const FloatingWhatsAppButton = () => {
    ...
    return (
      <a
        href={`https://api.whatsapp.com/send?phone=${phone}&text=Hi! I’d like to book a free consultation.`}
        target="_blank"
      ...
      <main className="max-w-4xl mx-auto">
        <section className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <p className="text-gray-700 text-lg">
            ...
            clarity, confidence, and success. Whether it’s personal growth, career, or relationships — you don’t have to do it alone.
          </p>
        </section>
